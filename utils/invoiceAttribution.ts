 ...
 * @returns {string | null}
 */
function sanitizePersonName(value, opts: any = {}) {
...
function hasReceptionInput(body: any = {}) {
  return bodyHasAnyKey(body, RECEPTION_KEYS);
}

function hasRepresentativeInput(body: any = {}) {
 ...
 * @returns {string}
 */
function resolveReceptionEngineer(body: any = {}) {
  const raw =
 ...
 * @returns {string | null}
 */
function resolveRepresentative(body: any = {}) {
  const raw =

...
export const createCategoryCode = asyncHandler(async (req, res, next) => {
...
// @access private
export const getCategoryCode = asyncHandler(async (req, res, next) => {
  const { id } = req.params;     
  const { code } = req.body;      
...
// @access private
export const getallCategoryCode = factory.getAll(CategoryCode);
...
// @access private
export const searchInCategory = asyncHandler(async (req, res, next) => {
...
// @access private
export const getallCategoryOnly = asyncHandler(async (req, res, next) => {
...
// @access private
export const moveGeneratedCode = asyncHandler(async (req, res, next) => {
...
// @access private
export const deleteCategoryCode = asyncHandler(async (req, res, next) => {
  const { id } = req.params;

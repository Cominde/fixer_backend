...
// NOTE: this suite is written for Jest and needs `jest` + `supertest` installed
// to run. Neither is currently a dependency of this project, so the file is
// type-checked but never executed. The reference above scopes the Jest globals
// to this file only, so they do not leak into the rest of the program.

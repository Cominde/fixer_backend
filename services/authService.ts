...
// @access  Public
export const loginByCarCode = asyncHandler(async (req, res, next) => {
...
export const protect = asyncHandler(async (req, res, next) => {
  ...
  if (currentUser.passwordChangedAt) {
    const passChangedTimestamp = parseInt(
      (currentUser.passwordChangedAt.getTime() / 1000) as any,
      10,
    );
...
// @access  Public
export const loginByMail = asyncHandler(async (req, res, next) => {
...
// @access  private
export const forgotPasswordForAdmin = asyncHandler(async (req, res, next) => {
  const user = await User.findOne({
    email: req.body.email,
  });
...
// @access  private
export const resetPasswordForAdmin = asyncHandler(async (req, res, next) => {
...
// @route   POST /api/v1/auth/admin/resetPassword
// @access  private
export const setEmailAndPassword = asyncHandler(async (req, res, next) => {
  const { email, password } = req.body;
  if (!email || !password) {
...
// @access  Public
export const workerLogin = asyncHandler(async (req, res, next) => {
